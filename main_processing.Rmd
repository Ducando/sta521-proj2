...
image_log <- CVmaster2(model = "logistic", X = X_train_image, y =y_train_image, 
                       k = 10, loss = c("accuracy"), estimates = c("roc", "conf_mat"))
# RF
image_rf <- CVmaster2(model = "rf", X = X_train_image, y = y_train_image ,
                      k = 10, loss = c("accuracy"), estimates = c("roc", "conf_mat"))

# BOOSTED TREES 
image_boost <- CVmaster2(model = "boosted_trees", X = X_train_blocks, y = y_train_blocks ,
                      k = 10, loss = c("accuracy"), estimates = c("roc", "conf_mat")) 
...
# BOOSTED TREES 
block_boost <- CVmaster2(model = "boosted_trees", X = X_train_blocks, y = y_train_blocks ,
                      k = 10, loss = c("accuracy"), estimates = c("roc", "conf_mat")) 
