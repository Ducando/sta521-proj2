...
```{r}
lda_accuracy <- CVmaster("lda", X_train, y_train,10,"accuracy")
lda_accuracy
mean(lda_accuracy)
```

```{r}
qda_accuracy <- CVmaster("qda", X_train, y_train,10,"accuracy")
qda_accuracy
mean(qda_accuracy)
```

```{r}
log_accuracy <- CVmaster("logistic", X_train, y_train,10,"accuracy")
log_accuracy
mean(log_accuracy)
```
...
rf_accuracy <- CVmaster("rf", X_train, y_train,10,"accuracy")
rf_accuracy
mean(rf_accuracy)
```
