...
image_1_pred_class <- image_1_pred_class %>%
  mutate(misclassified = ifelse(imagem1$expert != 0 & class != imagem1$expert,1,0))
...
image_2_pred_class <- image_2_pred_class %>%
  mutate(misclassified = ifelse(imagem2$expert != 0 & class != imagem2$expert,1,0))
...
image_3_pred_class <- image_3_pred_class %>%
  mutate(misclassified = ifelse(imagem3$expert != 0 & class != imagem3$expert,1,0))
