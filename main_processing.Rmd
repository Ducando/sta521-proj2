...
# LOGISTIC 
image_log <- CVmaster2(model = "logistic", 
                       X = X_train_image, y =y_train_image, 
                       k = 10, loss = c("accuracy"), 
                       estimates = c("roc", "conf_mat", "precision"))
# RF
image_rf <- CVmaster2(model = "rf",
                      X = X_train_image, y = y_train_image,
                      k = 10, loss = c("accuracy"), 
                      estimates = c("roc", "conf_mat", "precision"))

# BOOSTED TREES 
image_boost <- CVmaster2(model = "boosted_trees", 
                         X = X_train_image, y = y_train_image,
                         k = 10, loss = c("accuracy"), 
                         estimates = c("roc", "conf_mat", "precision")) 
...
# LDA 
image_lda <- CVmaster2(model = "lda", 
                         X = X_train_image, y = y_train_image,
                         k = 10, loss = c("accuracy"), 
                         estimates = c("roc", "conf_mat", "precision")) 
# QDA 
image_qda <- CVmaster2(model = "qda", 
                         X = X_train_image, y = y_train_image,
                         k = 10, loss = c("accuracy"), 
                         estimates = c("roc", "conf_mat", "precision")) 

# SVM 
image_svm <- CVmaster2(model = "svm", 
                         X = X_train_image, y = y_train_image,
                         k = 10, loss = c("accuracy"), 
                         estimates = c("roc", "conf_mat", "precision")) 
...
## RUN BLOCK MODELS 
# LOGISTIC 
block_log <- CVmaster2(model = "logistic", 
                       X = X_train_blocks, y =y_train_blocks, 
                       k = 10, loss = c("accuracy"), 
                       estimates = c("roc", "conf_mat", "precision"))
# RF
block_rf <- CVmaster2(model = "rf", 
                      X = X_train_blocks, y = y_train_blocks,
                      k = 10, loss = c("accuracy"), 
                      estimates = c("roc", "conf_mat", "precision"))

# BOOSTED TREES 
block_boost <- CVmaster2(model = "boosted_trees", 
                         X = X_train_blocks, y = y_train_blocks,
                         k = 10, loss = c("accuracy"), 
                         estimates = c("roc", "conf_mat", "precision")) 
# LDA 
block_lda <- CVmaster2(model = "lda", 
                         X = X_train_blocks, y = y_train_blocks,
                         k = 10, loss = c("accuracy"), 
                         estimates = c("roc", "conf_mat", "precision")) 
# QDA 
block_qda <- CVmaster2(model = "qda", 
                         X = X_train_blocks, y = y_train_blocks,
                         k = 10, loss = c("accuracy"), 
                         estimates = c("roc", "conf_mat", "precision")) 
...
```{r}
folds <- caret::createFolds(y_train_image,5)
costs <- seq(0.1, 15, length.out = 5)
degrees <- seq(5)

# fit model for each fold, and each get predictions and accuracy 
fitModel <- function(i) {
...
accuracies <- map(seq(5), function(i){
  folds_res[[i]]$accuracy
})

accuracies <- data.frame(folds = seq(5), accuracy = unlist(accuracies))


# combine predictions 
preds <- map(seq(5), function(i){
  folds_res[[i]]$preds
})
...
```{r}
# image_log %>%
#   select_best() -> test_best
# 
# image_log %>%
#         collect_predictions(parameters = test_best) -> test_log
# 
# test_log %>%
# group_by(id) %>%
